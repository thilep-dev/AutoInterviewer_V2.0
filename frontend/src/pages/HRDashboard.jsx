...
function SideMenu() {
  ...
  return (
    <div style={{
      ...
      <button className="hover:bg-blue-100 w-full text-left px-6 py-2" onClick={() => navigate("/")}>
        Dashboard
      </button>
      <button className="hover:bg-blue-100 w-full text-left px-6 py-2" onClick={() => navigate("/candidate/new")}> 
        Add Candidate
      </button>
      <button className="hover:bg-blue-100 w-full text-left px-6 py-2" onClick={() => navigate("/compare")}> 
        Compare Candidates
      </button>
    </div>
  );
