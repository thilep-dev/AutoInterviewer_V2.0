import { setLogLevel as Vn, LogLevel as St, setLogExtension as Hn, RoomEvent as y, ParticipantEvent as w, Track as R, TrackEvent as Yt, compareVersions as zn, Room as Et } from "livekit-client";
...
const er = async (e, t, n) => {
  ...
  for (let p = 0; p < a.length; p++) {
    ...
    }, b && m <= 50 && (m++, typeof b == "object" && (b.placement && (h = b.placement), b.rects && (u = b.rects === !0 ? await s.getElementRects({
      reference: e,
      floating: t,
      strategy: i
    }) : b.rects), {
...
async function Qt(e, t) {
  ...
  const {
    ...
    altBoundary: h = !1,
    padding: d = 0
  } = He(t, e), m = Zn(d), g = a[h ? f === "floating" ? "reference" : "floating" : f], v = Fe(await o.getClippingRect({
  ...
  return {
    top: (v.top - b.top + m.top) / P.y,
    bottom: (b.bottom - v.bottom + m.bottom) / P.y,
    left: (v.left - b.left + m.left) / P.x,
    right: (b.right - v.right + m.right) / P.x
  };
}
const tr = function(e) {
  return e === void 0 && (e = {}), {
    ...
    async fn(t) {
      ...
      if ((n = o.arrow) != null && n.alignmentOffset)
        return {};
      const v = ae(i), x = he(a), E = ae(a) === a, P = await (c.isRTL == null ? void 0 : c.isRTL(u.floating)), b = h || (E || !p ? [Ne(a)] : Gn(a)), S = m !== "none";
      !h && S && b.push(...Jn(a, p, m, P));
...
const rr = function(e) {
  ...
  return e === void 0 && (e = {}), {
    ...
    async fn(t) {
      ...
      let d = u[h], m = u[f];
      if (o) {
        const g = h === "y" ? "top" : "left", v = h === "y" ? "bottom" : "right", x = d + l[g], E = d - l[v];
        d = Tt(x, d, E);
      }
      if (s) {
        const g = f === "y" ? "top" : "left", v = f === "y" ? "bottom" : "right", x = m + l[g], E = m - l[v];
        m = Tt(x, m, E);
      }
      const p = a.fn({
        ...t,
...
function ce(e, t, n, r) {
  ...
  if (o) {
    const h = U(o), d = r && Y(r) ? U(r) : r;
    let m = h, p = ot(m);
    for (; p && r && d !== m; ) {
      const g = de(p), v = p.getBoundingClientRect(), x = q(p), E = v.left + (p.clientLeft + parseFloat(x.paddingLeft)) * g.x, P = v.top + (p.clientTop + parseFloat(x.paddingTop)) * g.y;
...
function ur(e) {
  ...
  const l = G(0), f = Q(r);
  if ((f || !f && !o) && ((be(r) !== "body" || Oe(s)) && (c = Ke(r)), Q(r))) {
    const d = ce(r);
...
function hr(e, t) {
  ...
  if (n)
    return n;
  let r = Te(e, [], !1).filter((a) => Y(a) && be(a) !== "body"), i = null;
...
function xr(e, t) {
  ...
  function s(a, c) {
    ...
    if (a || t(), !h || !d)
      return;
    const m = Le(f), p = Le(i.clientWidth - (l + h)), g = Le(i.clientHeight - (f + d)), v = Le(l), E = {
...
function Sr(e, t, n, r) {
  ...
  function g() {
    const v = ce(e);
    p && !on(p, v) && n(), p = v, m = requestAnimationFrame(g);
  }
  return n(), () => {
    var v;
    l.forEach((x) => {
...
function hi(e, t) {
  ...
  return B(function(f, h) {
    ...
    d = f.subscribe(W(h, function(x) {
      m == null || m.unsubscribe(), g++, h.next(p = x), i > 0 && v(i);
...
function yi(e, t, n, r, i, o, s, a) {
  var c = [], u = 0, l = 0, f = !1, h = function() {
    ...
    u++;
    var g = !1;
    H(n(p, l++)).subscribe(W(t, function(v) {
      t.next(v);
    }, function() {
      g = !0;
    }, void 0, function() {
...
function ct(e, t) {
  return B(Ai(e, t, arguments.length >= 2, !0));
}
function _i(e) {
  e === void 0 && (e = {});
  ...
  return function(u) {
    ...
    return B(function(E, P) {
      ...
      P.add(function() {
        ...
        error: function(S) {
          p = !0, g(), f = et(v, i, S), b.error(S);
        },
        complete: function() {
          m = !0, g(), f = et(v, s), b.complete();
        }
      }), H(E).subscribe(l));
    })(u);
  };
...
var Mi = Object.defineProperty, Ri = Object.defineProperties, Di = Object.getOwnPropertyDescriptors, Ft = Object.getOwnPropertySymbols, $i = Object.prototype.hasOwnProperty, Ni = Object.prototype.propertyIsEnumerable, Ut = (e, t, n) => t in e ? Mi(e, t, { enumerable: !0, configurable: !0, writable: !0, value: n }) : e[t] = n, X = (e, t) => {
  for (var n in t || (t = {}))
  ...
  return e;
}, Ee = (e, t) => Ri(e, Di(t)), V = (e, t, n) => new Promise((r, i) => {
  var o = (c) => {
    try {
      a(n.next(c));
    } catch (u) {
...
function rs(e, t, n = !0) {
  const r = new k((o) => {
    ...
    const a = () => V(this, null, function* () {
      try {
        const c = yield Et.getLocalDevices(e, n);
        o.next(c);
      } catch (c) {
        t == null || t(c);
      }
...
function ds(e, t, n, r, i) {
  const { localParticipant: o } = t, s = (f, h) => {
    ...
    D(s(e, o))
  ), c = new Z(), u = (f, h) => V(this, null, function* () {
    try {
...
function mo(e, t, n) {
  ...
  return { messageObservable: i, isSendingObservable: s, send: (c, ...u) => V(this, [c, ...u], function* (l, f = {}) {
    o.next(!0);
    try {
      yield Mn(e.localParticipant, l, X({ topic: r[0] }, f));
    } finally {
      o.next(!1);
    }
  }) };
...
function ws(e, t) {
  ...
  if (h) {
    ...
    b.pipe(
      A((S) => {
        const C = p(S.payload);
        return go(C) ? void 0 : Ee(X({}, C), { from: S.from });
      }),
      Qe((S) => !!S),
      Nt(u)
    ).subscribe(m);
  ...
  const g = m.pipe(
    ...
    Nt(u)
  ), v = new ln(!1), x = (a = t == null ? void 0 : t.messageEncoder) != null ? a : yo, E = (b, S) => V(this, null, function* () {
    var C;
...
var Eo = `${Tn}-user-choices`, Se = {
  videoEnabled: !0,
  audioEnabled: !0,
  videoDeviceId: "default",
  audioDeviceId: "default",
  username: ""
}, { load: To, save: Co } = So(Eo);
function Is(e, t = !1) {
  t !== !0 && Co(e);
}
function Ms(e, t = !1) {
...
function Rs(e, t) {
  ...
  const a = o.asObservable().pipe(_i());
...
//# sourceMappingURL=contexts-VkyY-dAg.mjs.map
